...
doubly_cov <- c("AGE_cal", "GENDER", "MedInfo" , "Asthma", "chronic.lung.disease", "heart.failure_past", "Hypertension", "Psychiatric.disorders", "Antiplatelets", "immunosuppressant", "Lipid.lowering.agents.including.statin", "arrhythmias.or.antiarrhythmias.use")

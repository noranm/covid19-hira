...
# (def) AGE 
patient_info$AGE = 2020 - as.numeric(substr(patient_info$PAT_BTH,1,4))
...
patient_info$AGE.75_ <- ifelse(patient_info$AGE >= 75, 1, 0)
...
for (j in ncol(patient_info):ncol(covid_diag)) {
...
################## statin 120 #####################
# model 1
fit1.statin120 <- glm(statin120[,statin.exposure] ~ ., data = statin120[,c(statin.exposure, statin.regression_predictor)], family="binomial")
statin120$ps <- predict(fit1.statin120, type="response")  

# model 2a
fit2a.statin120 <- glm(statin120[,"Death"]~statin120[,statin.exposure], data=statin120[,c("Death", statin.exposure)], family="binomial")
pred2a.statin120 <- predict(fit2a.statin120, type="response")

# model 2b
fit2b.statin120 <- glm(statin120[,"Death"]~., data=statin120[,c("Death",statin.exposure,statin.regression_predictor)], family="binomial")
pred2b.statin120 <- predict(fit2b.statin120, type="response")

# model 2c
fit2c.statin120 <- glm(statin120[,"Death"]~., data=statin120[,c("Death",statin.exposure,statin.regression_predictor)], weight = 1/statin120$ps,family="binomial")
pred2c.statin120 <- predict(fit2c.statin120, type="response")
...
################## anti 120 #####################
# model 1
fit1.anti120 <- glm(anti120[,anti.exposure] ~ ., data = anti120[,c(anti.exposure, anti.regression_predictor)], family="binomial")
anti120$ps <- predict(fit1.anti120, type="response")  

# model 2a
fit2a.anti120 <- glm(anti120[,"Death"]~anti120[,anti.exposure], data=anti120[,c("Death", anti.exposure)], family="binomial")
pred2a.anti120 <- predict(fit2a.anti120, type="response")

# model 2b
fit2b.anti120 <- glm(anti120[,"Death"]~., data=anti120[,c("Death",anti.exposure,anti.regression_predictor)], family="binomial")
pred2b.anti120 <- predict(fit2b.anti120, type="response")

# model 2c
fit2c.anti120 <- glm(anti120[,"Death"]~., data=anti120[,c("Death",anti.exposure,anti.regression_predictor)], weight = 1/anti120$ps,family="binomial")
pred2c.anti120 <- predict(fit2c.anti120, type="response")
...
##################### immune 120  #######################
# model 1
fit1.immune120 <- glm(immune120[,immune.exposure] ~ ., data = immune120[,c(immune.exposure, immune.regression_predictor)], family="binomial")
immune120$ps <- predict(fit1.immune120, type="response")  

# model 2a
fit2a.immune120 <- glm(immune120[,"Death"]~immune120[,immune.exposure], data=immune120[,c("Death", immune.exposure)], family="binomial")
pred2a.immune120 <- predict(fit2a.immune120, type="response")

# model 2b
fit2b.immune120 <- glm(immune120[,"Death"]~., data=immune120[,c("Death",immune.exposure,immune.regression_predictor)], family="binomial")
pred2b.immune120 <- predict(fit2b.immune120, type="response")

# model 2c
fit2c.immune120 <- glm(immune120[,"Death"]~., data=immune120[,c("Death",immune.exposure,immune.regression_predictor)], weight = 1/immune120$ps,family="binomial")
pred2c.immune120 <- predict(fit2c.immune120, type="response")
...
patient_info2$AGE <- as.factor(patient_info2$AGE) 
...
cat(" [INSUP_TP_CD] 4: 건강보험 5: 의료급여 7:보훈\n")
cat(" [SEX_TP_CD] 1: 남 2: 여\n\n")

# ---------------------------------- statin
cat("\n =========== (1) statin 30 =========== \n")
cat("\n > summary(statin30$ps)\n")
summary(statin30$ps)
cat("\n > summary(fit1.statin30)\n")
summary(fit1.statin30)
cat("\n > summary(fit2a.statin30)\n")
summary(fit2a.statin30)
cat("\n > summary(fit2b.statin30)\n")
summary(fit2b.statin30)
cat("\n > summary(fit2c.statin30)\n")
summary(fit2c.statin30)

cat("\n =========== (2) statin 120 =========== \n")
cat("\n > summary(statin120$ps)\n")
summary(statin120$ps)
cat("\n > summary(fit1.statin120)\n")
summary(fit1.statin120)
cat("\n > summary(fit2a.statin120)\n")
summary(fit2a.statin120)
cat("\n > summary(fit2b.statin120)\n")
summary(fit2b.statin120)
cat("\n > summary(fit2c.statin120)\n")
summary(fit2c.statin120)
...
cat("\n > summary(fit1.anti30)\n")
summary(fit1.anti30)
cat("\n > summary(fit2a.anti30)\n")
summary(fit2a.anti30)
cat("\n > summary(fit2b.anti30)\n")
summary(fit2b.anti30)
cat("\n > summary(fit2c.anti30)\n")
summary(fit2c.anti30)

cat("\n =========== (4) anti 120 =========== \n")
cat("\n > summary(anti120$ps)\n")
summary(anti120$ps)
cat("\n > summary(fit1.anti120)\n")
summary(fit1.anti120)
cat("\n > summary(fit2a.anti120)\n")
summary(fit2a.anti120)
cat("\n > summary(fit2b.anti120)\n")
summary(fit2b.anti120)
cat("\n > summary(fit2c.anti120)\n")
summary(fit2c.anti120)
...
cat("\n > summary(immune30$ps)\n")
summary(immune30$ps)
cat("\n > summary(fit1.immune30)\n")
summary(fit1.immune30)
cat("\n > summary(fit2a.immune30)\n")
summary(fit2a.immune30)
cat("\n > summary(fit2b.immune30)\n")
summary(fit2b.immune30)
cat("\n > summary(fit2c.immune30)\n")
summary(fit2c.immune30)

cat("\n =========== (6) immune 120 =========== \n")
cat("\n > summary(immune120$ps)\n")
summary(immune120$ps)
cat("\n > summary(fit1.immune120)\n")
summary(fit1.immune120)
cat("\n > summary(fit2a.immune120)\n")
summary(fit2a.immune120)
cat("\n > summary(fit2b.immune120)\n")
summary(fit2b.immune120)
cat("\n > summary(fit2c.immune120)\n")
summary(fit2c.immune120)
